...
MainBox::MainBox(){
    ...
    aboutBox.setText("<font size=4><b>Balance of Power: Reviewed</b> ver beta 1.0</font><br><br><br>a complex turn-based Cold War geopolitical simulation game<br><br><b>original author:</b> Chris Crawford (1985, 1988)<br><b>author of the port:</b> Tomasz Ciborski (2016)");
...
void MainBox::drawMap(int t, int addParam, bool inOutMode){
    ...
    if(t==0)
        ...
        for(int i=0;i<N;i++) tempVal[i]=(core.state[i].gdpFrac[t-34]*255);
    else if(t==37)
...
void MainBox::initLegend(){
    legend[0]=QRect(QPoint(618,342),QPoint(638,365));
    legend[1]=QRect(QPoint(618,372),QPoint(638,395));
    legend[2]=QRect(QPoint(618,402),QPoint(638,425));
    for(int i=0;i<3;i++) {
    ...
    legendLabel[0]->move(QPoint(650,348));
    legendLabel[1]->move(QPoint(650,378));
    legendLabel[2]->move(QPoint(650,408));

    legendCaption=new QLabel(this);
    legendCaption->move(QPoint(618,438));

    countryHighlight=new QLabel(this);
    countryHighlight->move(QPoint(618,450));
}
...
void MainBox::paintEvent(QPaintEvent * /* event */)
{
    ...
    painter.drawLine(12,359,12,253);
    painter.drawLine(12,253,70,253);
    painter.drawLine(70,253,158,329);
    painter.drawLine(158,329,158,359);
    painter.drawLine(158,359,12,359);
