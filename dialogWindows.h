...
public:
    ...
    QBoxLayout *dataColLayout[6];
    QBoxLayout *chartLayout[5];
    QBoxLayout *tableLayout[3];
    QBoxLayout *rowLayout[2];
    QBoxLayout *lowChartsColumnLayout[6];
    QBoxLayout *grandTableLayout;
};
